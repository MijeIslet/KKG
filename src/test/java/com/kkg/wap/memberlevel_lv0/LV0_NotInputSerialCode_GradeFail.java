...
import com.kkg.wap.pageobject.Login_LV0_2;
import org.testng.annotations.AfterClass;
import org.testng.annotations.BeforeClass;
import org.testng.annotations.Test;

public class LV0_NotInputSerialCode_GradeFail {
    ...
    public void setUp() throws Exception {
        ...
        //登录
        Login_LV0_2 login = new Login_LV0_2(kkgFrame);
        login.Login();
    ...
    @Test(description = "普通用户升级会员时未填写服务码时升级失败")
    public void LV0_NotInputSerialCode_GradeFail() throws Exception {
        //关闭广告
       ...
       //点击会员中心
        ...
        //断言
        try {
            kkgFrame.expectTextExistOrNot(true,"请先填写用户服务码");
            System.out.println("请先填写用户服务码");
        } catch (Exception e) {
