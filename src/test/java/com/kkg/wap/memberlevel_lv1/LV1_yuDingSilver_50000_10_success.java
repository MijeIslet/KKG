...
public class LV1_yuDingSilver_50000_10_success {
    ...
    @Test(description = "一级会员下单，白银单笔可预订最大克重500000g，下单成功")
    public void yuDing_Silver50000g_10_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV1 白银单笔可预订最大克重500000g，下单成功");
        } catch (Exception e) {
