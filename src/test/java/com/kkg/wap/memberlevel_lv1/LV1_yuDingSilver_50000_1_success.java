...
public class LV1_yuDingSilver_50000_1_success {
    ...
    @Test(description = "一级会员下预订单50000g白银成功")
    public void yuDing_Silver50000g_1_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV1 预订50000g白银成功");
        } catch (Exception e) {
