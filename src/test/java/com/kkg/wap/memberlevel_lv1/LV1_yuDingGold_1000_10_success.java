...
public class LV1_yuDingGold_1000_10_success {
    ...
    @Test(description = "一级会员下单，黄金单笔可预订最大克重10000g，下单成功")
    public void yuDing_Gold1000g_10_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV1黄金单笔可预订最大克重10000g，下单成功");
        } catch (Exception e) {
