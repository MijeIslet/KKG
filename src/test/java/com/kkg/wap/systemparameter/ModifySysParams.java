...
public class ModifySysParams {
    ...
    @Test
    public void modifySysParams()throws Exception {
        //关闭广告
        ...
        kkgFrame.pause(3000);
        //修改参数
        kkgFrame.typeById("tp","150");
        kkgFrame.typeById("cl","80");
        kkgFrame.typeById("ts","20");
        kkgFrame.typeById("amounts","2000");
