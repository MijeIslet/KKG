...
public class LV2_yuDingSilver_5000_1_success {
    ...
    @Test(description = "二级会员下预订单5000g白银成功")
    public void yuDing_Silver50000_1_sucess ()throws Exception {
            //关闭广告
        guanggao = kkgFrame.isContainTextFromPageSourceOrNot("<div class=\"pub_mask \" id=\"pub_mask\" style=\"display: block;\">");
            ...
            try {
                ...
                System.out.println("LV2 5000g白银预订成功");
            } catch (Exception e) {
