...
public class LV2_yuDingGold_3000_1_success {
    ...
    @Test(description = "二级会员下预订单3000g黄金成功")
    public void yuDing_Gold3000g_1_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV2预订黄金3000g成功");
        } catch (Exception e) {
