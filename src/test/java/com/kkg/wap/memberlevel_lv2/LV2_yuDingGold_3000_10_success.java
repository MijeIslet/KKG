...
public class LV2_yuDingGold_3000_10_success {
    ...
    @Test(description = "二级会员下单，黄金单笔可预订最大克重30000g，下单成功")
    public void yuDing_Gold3000g_10_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV2 黄金单笔可预订最大克重30000g，下单成功");
        } catch (Exception e) {
