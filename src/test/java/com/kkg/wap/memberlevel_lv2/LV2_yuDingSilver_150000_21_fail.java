...
public class LV2_yuDingSilver_150000_21_fail {
    ...
    @Test(description = "二级会员下单，超过累计预订/回购最大金额200000，下单失败")
    public void yuDing_Silver150000g_21_fail ()throws Exception {
        //关闭广告
        ...
        kkgFrame.typeByXpath("//*[@class=\"count_div\"]/input[1]","21");
        kkgFrame.pause(2000);
        //点击预付款
        ...
        try {
            ...
            System.out.println("下单失败，超出等级限定金额");
        } catch (Exception e) {
