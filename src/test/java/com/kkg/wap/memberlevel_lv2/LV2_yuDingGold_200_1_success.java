...
public class LV2_yuDingGold_200_1_success {
    ...
    @Test(description = "二级会员下预订单200g黄金成功")
    public void yuDing_Gold200g_1_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV2 预订黄金200成功");
        } catch (Exception e) {
