...
public class RegisterNewAccountAndUpgradeWholeFlow {
...
//      String kkgPath_pro = "https://prowap.kkgold.com/login";
    ...
    public void upGradeFlow() throws Exception {
        ...
        kkgFrame.pause(3000);
        //输入注册信息
        kkgFrame.typeById("username", "秋雨92");
        ...
        kkgFrame.pause(2000);
        kkgFrame.typeById("userSerialcode","382808");
        ...
        kkgFrame.pause(3000);
        //阅读风险书
        kkgFrame.clickByLinkText("阅读");
        kkgFrame.pause(2000);
        kkgFrame.clickByName("Fruit");
        kkgFrame.clickById("agree_protocol");
        kkgFrame.expectTextExistOrNot(true,"已阅读");
        kkgFrame.pause(2000);
        //点击开通体验用户按钮
        kkgFrame.clickByClass("grade_btn");
        kkgFrame.pause(3000);
        //假实名，从数据库插入数据假实名
        try {
            kkgFrame.realnameFromDB(mobile);
            //充值，从B系统蓝补
        }catch (Exception e){
            e.printStackTrace();
        }
