...
public class AtNotpayOrderListToPay {
    ...
    public void cancelOrder()throws Exception {
       ...
       kkgFrame.back();
        ...
        //去付款
        kkgFrame.clickByXpath("//*[@id=\"container\"]/div[3]/div[2]/div/span[2]");
        kkgFrame.WebDriverWaitUntilPageContainsElementByClass("confirm-payment");
        //确认支付
