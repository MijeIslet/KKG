...
public class ExperiencedUser_yuDingSilver_5000_11_fail {
    ...
    @Test(description = "体验用户下单，超过白银单笔可预订最大克重50000g，下单失败")
    public void yuDing_Silver5000g_11_fail ()throws Exception {
        //关闭广告
