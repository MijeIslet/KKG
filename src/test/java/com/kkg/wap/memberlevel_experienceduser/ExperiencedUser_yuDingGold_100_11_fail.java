...
public class ExperiencedUser_yuDingGold_100_11_fail {
    ...
    @Test(description = "体验用户下单，超过黄金单笔可预订最大克重1000g，下单失败")
    public void yuDing_Gold100g_11_sucess ()throws Exception {
        //关闭广告
