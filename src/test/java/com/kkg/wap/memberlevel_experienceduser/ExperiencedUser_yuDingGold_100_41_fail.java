...
public class ExperiencedUser_yuDingGold_100_41_fail {
    ...
    public void yuDing_Gold100g_41_fail ()throws Exception {
        //关闭广告
        ...
        kkgFrame.pause(2000);
        //选择100g 41件
        kkgFrame.typeByXpath("//*[@class=\"count_div\"]/input[1]","41");
        kkgFrame.pause(2000);
        //点击预付款
