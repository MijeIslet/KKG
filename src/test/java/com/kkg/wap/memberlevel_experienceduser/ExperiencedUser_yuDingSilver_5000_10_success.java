...
public class ExperiencedUser_yuDingSilver_5000_10_success {
    ...
    @Test(description = "体验用户下单，白银单笔可预订最大克重50000g，下单成功")
    public void yuDing_Silver5000g_10_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("白银单笔可预订最大克重50000g，下单成功");
        } catch (Exception e) {
