...
public class QuanUser_yuDingSilver_50000_1_fail {
    ...
    @Test(description = "券用户下预订单50000g白银失败")
    public void yuDing_Silver50000g_1_fail ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("券用户用券下50000g白银预订单失败：当前商品超出等级可预订限定的规格");
        } catch (Exception e) {
