...
public class LV3_yuDingSilver_250000_10_success {
    ...
    @Test(description = "3级会员下单，白银单笔可预订最大克重2500000g，下单成功")
    public void yuDing_Silver250000g_10_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV3白银单笔可预订最大克重2500000g，下单成功");
        } catch (Exception e) {
