...
public class LV3_yuDingGold_5000_10_success {
    ...
    @Test(description = "3级会员，黄金单笔可预订最大克重50000g，下单成功")
    public void yuDing_Gold5000g_10_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV3黄金单笔可预订最大克重50000g，下单成功");
        } catch (Exception e) {
