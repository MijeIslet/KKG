...
public class LV3_yuDingGold_1000_1_success {
    ...
    @Test(description = "3级会员下预订单1000g黄金成功")
    public void yuDing_Gold1000g_1_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV3预订黄金1000g成功");
        } catch (Exception e) {
