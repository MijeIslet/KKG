...
public class LV3_yuDingGold_5000_1_success {
    ...
    @Test(description = "3级会员下预订单5000g黄金成功")
    public void yuDing_Gold5000g_1_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV3预订黄金5000g成功");
        } catch (Exception e) {
