...
public class LV3_yuDingSilver_150000_1_success {
    ...
    @Test(description = "3级会员下预订单150000g白银成功")
    public void yuDing_Silver150000g_1_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV3预订150000g白银成功");
        } catch (Exception e) {
