...
public class LV3_yuDingSilver_250000_1_success {
    ...
    @Test(description = "3级会员下预订单250000g白银成功")
    public void yuDing_Silver250000g_1_success ()throws Exception {
        //关闭广告
        ...
        try {
            ...
            System.out.println("LV3预订250000g白银成功");
        } catch (Exception e) {
