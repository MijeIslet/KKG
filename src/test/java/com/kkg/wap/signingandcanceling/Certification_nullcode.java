...
public class Certification_nullcode {
    ...
    @Test
    public void certification_nullcode() throws Exception{
        //关闭广告
        ...
        kkgFrame.pause(2000);
        //输入验证码
        kkgFrame.typeById("code","");
        //提交
        kkgFrame.clickById("submit_txt");
        kkgFrame.pause(2000);
        //断言
        try {
            kkgFrame.expectTextExistOrNot(true,"验证码不能为空");
