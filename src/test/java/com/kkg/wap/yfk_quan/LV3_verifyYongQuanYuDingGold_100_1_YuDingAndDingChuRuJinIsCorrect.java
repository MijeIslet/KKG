...
public class LV3_verifyYongQuanYuDingGold_100_1_YuDingAndDingChuRuJinIsCorrect {
    ...
    public void verifyYuDingATDingChuRuJinIsCorrect() throws Exception {
        //关闭广告
        ...
        BigDecimal expectedam = new BigDecimal("217.50").setScale(2);
