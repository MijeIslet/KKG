...
public class ExperiencedUser_YongQuanYuDingGold_200_1_OverSizeFail {
    ...
    @Test(description = "体验用户用预付款券下预订单200g黄金失败，券不失效仍可再次使用")
    public void yuDing_Gold200g_1_fail ()throws Exception {
        //关闭广告
        ...
        try {
            kkgFrame.expectTextExistOrNot(true,"当前商品超出等级可预订限定的规格");
            System.out.println("用券预订下单失败后券没有失效！");
        } catch (Exception e) {
            System.out.println("系统异常");
        }
        //点击首页悬浮图标
