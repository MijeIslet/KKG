...
public class ModifyGenderToMan {
    ...
    @Test
    public void modifyGenderToMan()throws Exception {
        //关闭广告
        ...
        kkgFrame.pause(2000);
        //修改性别
        kkgFrame.clickByXpath("//*[@id=\"myModal\"]/div/div/div[2]/div/div[1]/div[2]/img");
        kkgFrame.pause(2000);
        //确定保存
        ...
        try{
            ...
            Assert.assertEquals(nickname,"男");
        }catch (Exception e){
            Assert.fail("修改性别失败");
        }
