...
public class SetNewAddressToDefaultAddress {
    ...
    @Test
    public void setNewAddressToDefaultAddress()throws Exception {
        //关闭广告
        ...
        kkgFrame.pause(2000);
        //设置新地址为默认地址
        kkgFrame.clickByXpath("//*[@class='mem_sh_cou']/div[2]/div[2]/div[1]/div[2]");
        kkgFrame.pause(2000);
        try{
