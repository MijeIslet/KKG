...
public class YuerAndJindoupay_TuiYuerAndJindou_YouxiantuiKdou {
    ...
    public void youXianTuiKdou_withoutjindou() throws Exception {
        ...
        //输入金豆
        kkgFrame.typeById("payBounty", "2.5");
        //确认支付
        ...
        BigDecimal expectedJindou = new BigDecimal("2.50").setScale(2);
        BigDecimal expectedam = new BigDecimal("7.50").setScale(2);
        BigDecimal expectedbal = new BigDecimal("7.50").setScale(2);
