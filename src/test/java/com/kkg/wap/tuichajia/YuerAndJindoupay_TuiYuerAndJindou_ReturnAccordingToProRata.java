...
public class YuerAndJindoupay_TuiYuerAndJindou_ReturnAccordingToProRata {
    ...
    public void youXianTuiKdou_withoutjindou() throws Exception {
        ...
        BigDecimal expectedam = new BigDecimal("9.90").setScale(2);
        BigDecimal expectedbal = new BigDecimal("9.90").setScale(2);
