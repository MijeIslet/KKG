...
public class Yuerpay_TuiYuer_MoreThan1000yuan {
    ...
    public void youXianTuiKdou_withoutjindou() throws Exception {
        ...
        BigDecimal expectedam = new BigDecimal("1100.00").setScale(2);
        BigDecimal expectedbal = new BigDecimal("1100.00").setScale(2);
