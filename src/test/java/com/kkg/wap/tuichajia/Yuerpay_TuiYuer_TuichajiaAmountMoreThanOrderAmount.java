...
public class Yuerpay_TuiYuer_TuichajiaAmountMoreThanOrderAmount {
    ...
    @Test (description = "测试退差价K豆数量不能大于订单支付K豆总额")
    public void yuerpay_Tuijindou_fail() throws Exception {
        //wap客户端下单
        ...
        tuiChaJia.youXianTuiKDouMoreThanOrderAmount("500");
