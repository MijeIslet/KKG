...
public class Yuerpay_TuiYuer_TuiChaJia_RejectAndReapply {
    ...
    public void youXianTuiKdou_withoutjindou() throws Exception {
        ...
        shenHeTuiChaJia.yiShenBoHui();


        //小B端重新申请退差价

        XiaoBTuiChaJia tuiChaJiaAgain = new XiaoBTuiChaJia(kkgFrame);
        tuiChaJiaAgain.xiaoBTuiChaJia();
        tuiChaJiaAgain.youXianTuiKDouReapply("10");

        //S系统再次审核退差价

        S_ShenHeTuiChaJia shenHeTuiChaJiaAgain = new S_ShenHeTuiChaJia(kkgFrame);
        shenHeTuiChaJiaAgain.shenHeTuiChaJia();
        shenHeTuiChaJiaAgain.yiShen();
        shenHeTuiChaJiaAgain.shanShen();
