...
public class Jindoupay_Tuijindou_QuanErXianJin {
    ...
    public void youXianTuiKdou_withoutjindou() throws Exception {
        ...
        BigDecimal expectedam = new BigDecimal("5.00").setScale(2);
        BigDecimal expectedbal = new BigDecimal("5.00").setScale(2);
