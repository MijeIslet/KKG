...
public class Jindoupay_Tuijindou_ReturnAccordingToProRata {
    ...
    public void youXianTuiKdou_withoutjindou() throws Exception {
        ...
        tuiChaJia.anShiJiZhiFuBiLiTuiHuang("5");
        ...
        BigDecimal expectedJindou = new BigDecimal("0.10").setScale(2);
        BigDecimal expectedam = new BigDecimal("4.90").setScale(2);
        BigDecimal expectedbal = new BigDecimal("4.90").setScale(2);
