...
public class Login_ExperiencedLevel_VerifyUpgradeFailOnly {
    private static KkgFrame kkgFrame;
    public Login_ExperiencedLevel_VerifyUpgradeFailOnly(KkgFrame kkgFrame) {
...
//      String kkgPath_pro = "https://prowap.kkgold.com/login";
        ...
        kkgFrame.pause(1000);
        kkgFrame.typeById("username","13711223325");
