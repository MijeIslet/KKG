...
public class Login_QuanLevel_VerifyUpgradeFailOnly {
    private static KkgFrame kkgFrame;
    public Login_QuanLevel_VerifyUpgradeFailOnly(KkgFrame kkgFrame) {
...
//      String kkgPath_pro = "https://prowap.kkgold.com/login";
        ...
        kkgFrame.pause(1000);
        kkgFrame.typeById("username","13711223335");
