...
public class TuiJindouAndYuer {
    ...
    public void Yuerpay()throws Exception {
        ...
        //输入退款备注
        kkgFrame.typeById("reasonInfo","自动化退款测试-退余额与金豆");
        //点击上传凭证
        ...
        BigDecimal expectedReturnJindou = new BigDecimal("2.00").setScale(2);
        BigDecimal expectedReturnam = new BigDecimal("6.00").setScale(2);
