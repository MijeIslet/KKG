...
public class RegisterWithCorrectSerialCode {
...
//      String kkgPath_pro = "https://prowap.kkgold.com/login";
    ...
    @Test
    public void registerWithSerialCode()throws Exception {
        //点击新用户注册
        ...
        //输入正确推荐码
        kkgFrame.typeById("serialcode","382808");
        //点击立即注册
        ...
        kkgFrame.typeById("username","13711223385");
