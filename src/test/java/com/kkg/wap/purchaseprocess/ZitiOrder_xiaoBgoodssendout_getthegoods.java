...
public class ZitiOrder_xiaoBgoodssendout_getthegoods {
    ...
    @Test
    public void zitiOrderProcessByXiaoB()throws Exception {
        //wap客户端下单
...
//        kkgFrame.clickByXpath("//*[@class=\"bulk_buying\"]/li[3]");
        ...
        try{
            ...
            kkgFrame.expectTextExistOrNot(true,"自提请联系400-118-6318转1");
            System.out.println("您的订单已支付成功!"+"自提请联系400-118-6318转1");
            kkgFrame.pause(2000);
        }catch(Exception e){
